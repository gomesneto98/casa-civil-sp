...
# ---------------------------------------------------------------------------
MUNICIPALITIES_DATA = [
    ("Adamantina", "Interior", None, None, None),
    ("Adolfo", "Interior", None, None, None),
    ("Aguaí", "Interior", None, None, None),
    ("Agudos", "Interior", None, None, None),
    ("Alambari", "Interior", None, None, None),
    ("Alfredo Marcondes", "Interior", None, None, None),
    ("Altair", "Interior", None, None, None),
    ("Altinópolis", "Interior", None, None, None),
    ("Alto Alegre", "Interior", None, None, None),
    ("Alumínio", "Interior", None, None, None),
    ("Alvinlândia", "Interior", None, None, None),
    ("Americana", "Interior", None, None, None),
    ("Amparo", "Interior", None, None, None),
    ("Américo Brasiliense", "Interior", None, None, None),
    ("Américo de Campos", "Interior", None, None, None),
    ("Analândia", "Interior", None, None, None),
    ("Andradina", "Interior", None, None, None),
    ("Angatuba", "Interior", None, None, None),
    ("Anhembi", "Interior", None, None, None),
    ("Anhumas", "Interior", None, None, None),
    ("Aparecida", "Vale do Paraíba", None, None, None),
    ("Aparecida d'Oeste", "Interior", None, None, None),
    ("Apiaí", "Interior", None, None, None),
    ("Aramina", "Interior", None, None, None),
    ("Arandu", "Interior", None, None, None),
    ("Arapeí", "Vale do Paraíba", None, None, None),
    ("Araraquara", "Interior", None, None, None),
    ("Araras", "Interior", None, None, None),
    ("Araçariguama", "Interior", None, None, None),
    ("Araçatuba", "Interior", None, None, None),
    ("Araçoiaba da Serra", "Interior", None, None, None),
    ("Arco-Íris", "Interior", None, None, None),
    ("Arealva", "Interior", None, None, None),
    ("Areias", "Vale do Paraíba", None, None, None),
    ("Areiópolis", "Interior", None, None, None),
    ("Ariranha", "Interior", None, None, None),
    ("Artur Nogueira", "Interior", None, None, None),
    ("Arujá", "Grande SP", None, None, None),
    ("Aspásia", "Interior", None, None, None),
    ("Assis", "Interior", None, None, None),
    ("Atibaia", "Interior", None, None, None),
    ("Auriflama", "Interior", None, None, None),
    ("Avanhandava", "Interior", None, None, None),
    ("Avaré", "Interior", None, None, None),
    ("Avaí", "Interior", None, None, None),
    ("Bady Bassitt", "Interior", None, None, None),
    ("Balbinos", "Interior", None, None, None),
    ("Bananal", "Vale do Paraíba", None, None, None),
    ("Barbosa", "Interior", None, None, None),
    ("Bariri", "Interior", None, None, None),
    ("Barra Bonita", "Interior", None, None, None),
    ("Barra do Chapéu", "Interior", None, None, None),
    ("Barra do Turvo", "Litoral", None, None, None),
    ("Barretos", "Interior", None, None, None),
    ("Barrinha", "Interior", None, None, None),
    ("Barueri", "Grande SP", None, None, None),
    ("Barão de Antonina", "Interior", None, None, None),
    ("Bastos", "Interior", None, None, None),
    ("Batatais", "Interior", None, None, None),
    ("Bauru", "Interior", None, None, None),
    ("Bebedouro", "Interior", None, None, None),
    ("Bento de Abreu", "Interior", None, None, None),
    ("Bernardino de Campos", "Interior", None, None, None),
    ("Bertioga", "Grande SP", None, None, None),
    ("Bilac", "Interior", None, None, None),
    ("Birigui", "Interior", None, None, None),
    ("Biritiba Mirim", "Grande SP", None, None, None),
    ("Boa Esperança do Sul", "Interior", None, None, None),
    ("Bocaina", "Interior", None, None, None),
    ("Bofete", "Interior", None, None, None),
    ("Boituva", "Interior", None, None, None),
    ("Bom Jesus dos Perdões", "Interior", None, None, None),
    ("Bom Sucesso de Itararé", "Interior", None, None, None),
    ("Boracéia", "Interior", None, None, None),
    ("Borborema", "Interior", None, None, None),
    ("Borebi", "Interior", None, None, None),
    ("Borá", "Interior", None, None, None),
    ("Botucatu", "Interior", None, None, None),
    ("Bragança Paulista", "Interior", None, None, None),
    ("Braúna", "Interior", None, None, None),
    ("Brejo Alegre", "Interior", None, None, None),
    ("Brodowski", "Interior", None, None, None),
    ("Brotas", "Interior", None, None, None),
    ("Buri", "Interior", None, None, None),
    ("Buritama", "Interior", None, None, None),
    ("Buritizal", "Interior", None, None, None),
    ("Bálsamo", "Interior", None, None, None),
    ("Cabreúva", "Interior", None, None, None),
    ("Cabrália Paulista", "Interior", None, None, None),
    ("Cachoeira Paulista", "Vale do Paraíba", None, None, None),
    ("Caconde", "Interior", None, None, None),
    ("Cafelândia", "Interior", None, None, None),
    ("Caiabu", "Interior", None, None, None),
    ("Caieiras", "Grande SP", None, None, None),
    ("Caiuá", "Interior", None, None, None),
    ("Cajamar", "Grande SP", None, None, None),
    ("Cajati", "Litoral", None, None, None),
    ("Cajobi", "Interior", None, None, None),
    ("Cajuru", "Interior", None, None, None),
    ("Campina do Monte Alegre", "Interior", None, None, None),
    ("Campinas", "Interior", None, None, None),
    ("Campo Limpo Paulista", "Interior", None, None, None),
    ("Campos Novos Paulista", "Interior", None, None, None),
    ("Campos do Jordão", "Vale do Paraíba", None, None, None),
    ("Cananéia", "Litoral", None, None, None),
    ("Canas", "Vale do Paraíba", None, None, None),
    ("Canitar", "Interior", None, None, None),
    ("Capela do Alto", "Interior", None, None, None),
    ("Capivari", "Interior", None, None, None),
    ("Capão Bonito", "Interior", None, None, None),
    ("Caraguatatuba", "Vale do Paraíba", None, None, None),
    ("Carapicuíba", "Grande SP", None, None, None),
    ("Cardoso", "Interior", None, None, None),
    ("Casa Branca", "Interior", None, None, None),
    ("Castilho", "Interior", None, None, None),
    ("Catanduva", "Interior", None, None, None),
    ("Catiguá", "Interior", None, None, None),
    ("Caçapava", "Vale do Paraíba", None, None, None),
    ("Cedral", "Interior", None, None, None),
    ("Cerqueira César", "Interior", None, None, None),
    ("Cerquilho", "Interior", None, None, None),
    ("Cesário Lange", "Interior", None, None, None),
    ("Charqueada", "Interior", None, None, None),
    ("Chavantes", "Interior", None, None, None),
    ("Clementina", "Interior", None, None, None),
    ("Colina", "Interior", None, None, None),
    ("Colômbia", "Interior", None, None, None),
    ("Conchal", "Interior", None, None, None),
    ("Conchas", "Interior", None, None, None),
    ("Cordeirópolis", "Interior", None, None, None),
    ("Coroados", "Interior", None, None, None),
    ("Coronel Macedo", "Interior", None, None, None),
    ("Corumbataí", "Interior", None, None, None),
    ("Cosmorama", "Interior", None, None, None),
    ("Cosmópolis", "Interior", None, None, None),
    ("Cotia", "Grande SP", None, None, None),
    ("Cravinhos", "Interior", None, None, None),
    ("Cristais Paulista", "Interior", None, None, None),
    ("Cruzeiro", "Vale do Paraíba", None, None, None),
    ("Cruzália", "Interior", None, None, None),
    ("Cubatão", "Grande SP", None, None, None),
    ("Cunha", "Vale do Paraíba", None, None, None),
    ("Cássia dos Coqueiros", "Interior", None, None, None),
    ("Cândido Mota", "Interior", None, None, None),
    ("Cândido Rodrigues", "Interior", None, None, None),
    ("Descalvado", "Interior", None, None, None),
    ("Diadema", "Grande SP", None, None, None),
    ("Dirce Reis", "Interior", None, None, None),
    ("Divinolândia", "Interior", None, None, None),
    ("Dobrada", "Interior", None, None, None),
    ("Dois Córregos", "Interior", None, None, None),
    ("Dolcinópolis", "Interior", None, None, None),
    ("Dourado", "Interior", None, None, None),
    ("Dracena", "Interior", None, None, None),
    ("Duartina", "Interior", None, None, None),
    ("Dumont", "Interior", None, None, None),
    ("Echaporã", "Interior", None, None, None),
    ("Eldorado", "Litoral", None, None, None),
    ("Elias Fausto", "Interior", None, None, None),
    ("Elisiário", "Interior", None, None, None),
    ("Embaúba", "Interior", None, None, None),
    ("Embu das Artes", "Grande SP", None, None, None),
    ("Embu-Guaçu", "Grande SP", None, None, None),
    ("Emilianópolis", "Interior", None, None, None),
    ("Engenheiro Coelho", "Interior", None, None, None),
    ("Espírito Santo do Pinhal", "Interior", None, None, None),
    ("Espírito Santo do Turvo", "Interior", None, None, None),
    ("Estiva Gerbi", "Interior", None, None, None),
    ("Estrela d'Oeste", "Interior", None, None, None),
    ("Estrela do Norte", "Interior", None, None, None),
    ("Euclides da Cunha Paulista", "Interior", None, None, None),
    ("Fartura", "Interior", None, None, None),
    ("Fernando Prestes", "Interior", None, None, None),
    ("Fernandópolis", "Interior", None, None, None),
    ("Fernão", "Interior", None, None, None),
    ("Ferraz de Vasconcelos", "Grande SP", None, None, None),
    ("Flora Rica", "Interior", None, None, None),
    ("Floreal", "Interior", None, None, None),
    ("Florínea", "Interior", None, None, None),
    ("Flórida Paulista", "Interior", None, None, None),
    ("Franca", "Interior", None, None, None),
    ("Francisco Morato", "Grande SP", None, None, None),
    ("Franco da Rocha", "Grande SP", None, None, None),
    ("Gabriel Monteiro", "Interior", None, None, None),
    ("Garça", "Interior", None, None, None),
    ("Gastão Vidigal", "Interior", None, None, None),
    ("Gavião Peixoto", "Interior", None, None, None),
    ("General Salgado", "Interior", None, None, None),
    ("Getulina", "Interior", None, None, None),
    ("Glicério", "Interior", None, None, None),
    ("Guaimbê", "Interior", None, None, None),
    ("Guaiçara", "Interior", None, None, None),
    ("Guapiara", "Interior", None, None, None),
    ("Guapiaçu", "Interior", None, None, None),
    ("Guaraci", "Interior", None, None, None),
    ("Guarani d'Oeste", "Interior", None, None, None),
    ("Guarantã", "Interior", None, None, None),
    ("Guararapes", "Interior", None, None, None),
    ("Guararema", "Grande SP", None, None, None),
    ("Guaratinguetá", "Vale do Paraíba", None, None, None),
    ("Guaraçaí", "Interior", None, None, None),
    ("Guareí", "Interior", None, None, None),
    ("Guariba", "Interior", None, None, None),
    ("Guarujá", "Grande SP", None, None, None),
    ("Guarulhos", "Grande SP", None, None, None),
    ("Guará", "Interior", None, None, None),
    ("Guatapará", "Interior", None, None, None),
    ("Guaíra", "Interior", None, None, None),
    ("Guzolândia", "Interior", None, None, None),
    ("Gália", "Interior", None, None, None),
    ("Herculândia", "Interior", None, None, None),
    ("Holambra", "Interior", None, None, None),
    ("Hortolândia", "Interior", None, None, None),
    ("Iacanga", "Interior", None, None, None),
    ("Iacri", "Interior", None, None, None),
    ("Iaras", "Interior", None, None, None),
    ("Ibaté", "Interior", None, None, None),
    ("Ibirarema", "Interior", None, None, None),
    ("Ibirá", "Interior", None, None, None),
    ("Ibitinga", "Interior", None, None, None),
    ("Ibiúna", "Interior", None, None, None),
    ("Icém", "Interior", None, None, None),
    ("Iepê", "Interior", None, None, None),
    ("Igarapava", "Interior", None, None, None),
    ("Igaratá", "Vale do Paraíba", None, None, None),
    ("Igaraçu do Tietê", "Interior", None, None, None),
    ("Iguape", "Litoral", None, None, None),
    ("Ilha Comprida", "Litoral", None, None, None),
    ("Ilha Solteira", "Interior", None, None, None),
    ("Ilhabela", "Vale do Paraíba", None, None, None),
    ("Indaiatuba", "Interior", None, None, None),
    ("Indiana", "Interior", None, None, None),
    ("Indiaporã", "Interior", None, None, None),
    ("Inúbia Paulista", "Interior", None, None, None),
    ("Ipaussu", "Interior", None, None, None),
    ("Iperó", "Interior", None, None, None),
    ("Ipeúna", "Interior", None, None, None),
    ("Ipiguá", "Interior", None, None, None),
    ("Iporanga", "Interior", None, None, None),
    ("Ipuã", "Interior", None, None, None),
    ("Iracemápolis", "Interior", None, None, None),
    ("Irapuru", "Interior", None, None, None),
    ("Irapuã", "Interior", None, None, None),
    ("Itaberá", "Interior", None, None, None),
    ("Itajobi", "Interior", None, None, None),
    ("Itaju", "Interior", None, None, None),
    ("Itanhaém", "Litoral", None, None, None),
    ("Itaoca", "Interior", None, None, None),
    ("Itapecerica da Serra", "Grande SP", None, None, None),
    ("Itapetininga", "Interior", None, None, None),
    ("Itapeva", "Interior", None, None, None),
    ("Itapevi", "Grande SP", None, None, None),
    ("Itapira", "Interior", None, None, None),
    ("Itapirapuã Paulista", "Interior", None, None, None),
    ("Itaporanga", "Interior", None, None, None),
    ("Itapura", "Interior", None, None, None),
    ("Itapuí", "Interior", None, None, None),
    ("Itaquaquecetuba", "Grande SP", None, None, None),
    ("Itararé", "Interior", None, None, None),
    ("Itariri", "Litoral", None, None, None),
    ("Itatiba", "Interior", None, None, None),
    ("Itatinga", "Interior", None, None, None),
    ("Itaí", "Interior", None, None, None),
    ("Itirapina", "Interior", None, None, None),
    ("Itirapuã", "Interior", None, None, None),
    ("Itobi", "Interior", None, None, None),
    ("Itu", "Interior", None, None, None),
    ("Itupeva", "Interior", None, None, None),
    ("Ituverava", "Interior", None, None, None),
    ("Itápolis", "Interior", None, None, None),
    ("Jaborandi", "Interior", None, None, None),
    ("Jaboticabal", "Interior", None, None, None),
    ("Jacareí", "Vale do Paraíba", None, None, None),
    ("Jaci", "Interior", None, None, None),
    ("Jacupiranga", "Litoral", None, None, None),
    ("Jaguariúna", "Interior", None, None, None),
    ("Jales", "Interior", None, None, None),
    ("Jambeiro", "Vale do Paraíba", None, None, None),
    ("Jandira", "Grande SP", None, None, None),
    ("Jardinópolis", "Interior", None, None, None),
    ("Jarinu", "Interior", None, None, None),
    ("Jaú", "Interior", None, None, None),
    ("Jeriquara", "Interior", None, None, None),
    ("Joanópolis", "Interior", None, None, None),
    ("José Bonifácio", "Interior", None, None, None),
    ("João Ramalho", "Interior", None, None, None),
    ("Jumirim", "Interior", None, None, None),
    ("Jundiaí", "Interior", None, None, None),
    ("Junqueirópolis", "Interior", None, None, None),
    ("Juquitiba", "Grande SP", None, None, None),
    ("Juquiá", "Litoral", None, None, None),
    ("Júlio Mesquita", "Interior", None, None, None),
    ("Lagoinha", "Vale do Paraíba", None, None, None),
    ("Laranjal Paulista", "Interior", None, None, None),
    ("Lavrinhas", "Vale do Paraíba", None, None, None),
    ("Lavínia", "Interior", None, None, None),
    ("Leme", "Interior", None, None, None),
    ("Lençóis Paulista", "Interior", None, None, None),
    ("Limeira", "Interior", None, None, None),
    ("Lindóia", "Interior", None, None, None),
    ("Lins", "Interior", None, None, None),
    ("Lorena", "Vale do Paraíba", None, None, None),
    ("Lourdes", "Interior", None, None, None),
    ("Louveira", "Interior", None, None, None),
    ("Lucianópolis", "Interior", None, None, None),
    ("Lucélia", "Interior", None, None, None),
    ("Luiziânia", "Interior", None, None, None),
    ("Lupércio", "Interior", None, None, None),
    ("Lutécia", "Interior", None, None, None),
    ("Luís Antônio", "Interior", None, None, None),
    ("Macatuba", "Interior", None, None, None),
    ("Macaubal", "Interior", None, None, None),
    ("Macedônia", "Interior", None, None, None),
    ("Magda", "Interior", None, None, None),
    ("Mairinque", "Interior", None, None, None),
    ("Mairiporã", "Grande SP", None, None, None),
    ("Manduri", "Interior", None, None, None),
    ("Marabá Paulista", "Interior", None, None, None),
    ("Maracaí", "Interior", None, None, None),
    ("Marapoama", "Interior", None, None, None),
    ("Marinópolis", "Interior", None, None, None),
    ("Mariápolis", "Interior", None, None, None),
    ("Martinópolis", "Interior", None, None, None),
    ("Marília", "Interior", None, None, None),
    ("Matão", "Interior", None, None, None),
    ("Mauá", "Grande SP", None, None, None),
    ("Mendonça", "Interior", None, None, None),
    ("Meridiano", "Interior", None, None, None),
    ("Mesópolis", "Interior", None, None, None),
    ("Miguelópolis", "Interior", None, None, None),
    ("Mineiros do Tietê", "Interior", None, None, None),
    ("Mira Estrela", "Interior", None, None, None),
    ("Miracatu", "Litoral", None, None, None),
    ("Mirandópolis", "Interior", None, None, None),
    ("Mirante do Paranapanema", "Interior", None, None, None),
    ("Mirassol", "Interior", None, None, None),
    ("Mirassolândia", "Interior", None, None, None),
    ("Mococa", "Interior", None, None, None),
    ("Mogi Guaçu", "Interior", None, None, None),
    ("Mogi Mirim", "Interior", None, None, None),
    ("Mogi das Cruzes", "Grande SP", None, None, None),
    ("Mombuca", "Interior", None, None, None),
    ("Mongaguá", "Litoral", None, None, None),
    ("Monte Alegre do Sul", "Interior", None, None, None),
    ("Monte Alto", "Interior", None, None, None),
    ("Monte Aprazível", "Interior", None, None, None),
    ("Monte Azul Paulista", "Interior", None, None, None),
    ("Monte Castelo", "Interior", None, None, None),
    ("Monte Mor", "Interior", None, None, None),
    ("Monteiro Lobato", "Vale do Paraíba", None, None, None),
    ("Monções", "Interior", None, None, None),
    ("Morro Agudo", "Interior", None, None, None),
    ("Morungaba", "Interior", None, None, None),
    ("Motuca", "Interior", None, None, None),
    ("Murutinga do Sul", "Interior", None, None, None),
    ("Nantes", "Interior", None, None, None),
    ("Narandiba", "Interior", None, None, None),
    ("Natividade da Serra", "Vale do Paraíba", None, None, None),
    ("Nazaré Paulista", "Interior", None, None, None),
    ("Neves Paulista", "Interior", None, None, None),
    ("Nhandeara", "Interior", None, None, None),
    ("Nipoã", "Interior", None, None, None),
    ("Nova Aliança", "Interior", None, None, None),
    ("Nova Campina", "Interior", None, None, None),
    ("Nova Canaã Paulista", "Interior", None, None, None),
    ("Nova Castilho", "Interior", None, None, None),
    ("Nova Europa", "Interior", None, None, None),
    ("Nova Granada", "Interior", None, None, None),
    ("Nova Guataporanga", "Interior", None, None, None),
    ("Nova Independência", "Interior", None, None, None),
    ("Nova Luzitânia", "Interior", None, None, None),
    ("Nova Odessa", "Interior", None, None, None),
    ("Novais", "Interior", None, None, None),
    ("Novo Horizonte", "Interior", None, None, None),
    ("Nuporanga", "Interior", None, None, None),
    ("Ocauçu", "Interior", None, None, None),
    ("Olímpia", "Interior", None, None, None),
    ("Onda Verde", "Interior", None, None, None),
    ("Oriente", "Interior", None, None, None),
    ("Orindiúva", "Interior", None, None, None),
    ("Orlândia", "Interior", None, None, None),
    ("Osasco", "Grande SP", None, None, None),
    ("Oscar Bressane", "Interior", None, None, None),
    ("Osvaldo Cruz", "Interior", None, None, None),
    ("Ourinhos", "Interior", None, None, None),
    ("Ouro Verde", "Interior", None, None, None),
    ("Ouroeste", "Interior", None, None, None),
    ("Pacaembu", "Interior", None, None, None),
    ("Palestina", "Interior", None, None, None),
    ("Palmares Paulista", "Interior", None, None, None),
    ("Palmeira d'Oeste", "Interior", None, None, None),
    ("Palmital", "Interior", None, None, None),
    ("Panorama", "Interior", None, None, None),
    ("Paraguaçu Paulista", "Interior", None, None, None),
    ("Paraibuna", "Vale do Paraíba", None, None, None),
    ("Paranapanema", "Interior", None, None, None),
    ("Paranapuã", "Interior", None, None, None),
    ("Parapuã", "Interior", None, None, None),
    ("Paraíso", "Interior", None, None, None),
    ("Pardinho", "Interior", None, None, None),
    ("Pariquera-Açu", "Litoral", None, None, None),
    ("Parisi", "Interior", None, None, None),
    ("Patrocínio Paulista", "Interior", None, None, None),
    ("Paulicéia", "Interior", None, None, None),
    ("Paulistânia", "Interior", None, None, None),
    ("Paulo de Faria", "Interior", None, None, None),
    ("Paulínia", "Interior", None, None, None),
    ("Pederneiras", "Interior", None, None, None),
    ("Pedra Bela", "Interior", None, None, None),
    ("Pedranópolis", "Interior", None, None, None),
    ("Pedregulho", "Interior", None, None, None),
    ("Pedreira", "Interior", None, None, None),
    ("Pedrinhas Paulista", "Interior", None, None, None),
    ("Pedro de Toledo", "Litoral", None, None, None),
    ("Penápolis", "Interior", None, None, None),
    ("Pereira Barreto", "Interior", None, None, None),
    ("Pereiras", "Interior", None, None, None),
    ("Peruíbe", "Litoral", None, None, None),
    ("Piacatu", "Interior", None, None, None),
    ("Piedade", "Interior", None, None, None),
    ("Pilar do Sul", "Interior", None, None, None),
    ("Pindamonhangaba", "Vale do Paraíba", None, None, None),
    ("Pindorama", "Interior", None, None, None),
    ("Pinhalzinho", "Interior", None, None, None),
    ("Piquerobi", "Interior", None, None, None),
    ("Piquete", "Vale do Paraíba", None, None, None),
    ("Piracaia", "Interior", None, None, None),
    ("Piracicaba", "Interior", None, None, None),
    ("Piraju", "Interior", None, None, None),
    ("Pirajuí", "Interior", None, None, None),
    ("Pirangi", "Interior", None, None, None),
    ("Pirapora do Bom Jesus", "Grande SP", None, None, None),
    ("Pirapozinho", "Interior", None, None, None),
    ("Pirassununga", "Interior", None, None, None),
    ("Piratininga", "Interior", None, None, None),
    ("Pitangueiras", "Interior", None, None, None),
    ("Planalto", "Interior", None, None, None),
    ("Platina", "Interior", None, None, None),
    ("Poloni", "Interior", None, None, None),
    ("Pompéia", "Interior", None, None, None),
    ("Pongaí", "Interior", None, None, None),
    ("Pontal", "Interior", None, None, None),
    ("Pontalinda", "Interior", None, None, None),
    ("Pontes Gestal", "Interior", None, None, None),
    ("Populina", "Interior", None, None, None),
    ("Porangaba", "Interior", None, None, None),
    ("Porto Feliz", "Interior", None, None, None),
    ("Porto Ferreira", "Interior", None, None, None),
    ("Potim", "Vale do Paraíba", None, None, None),
    ("Potirendaba", "Interior", None, None, None),
    ("Poá", "Grande SP", None, None, None),
    ("Pracinha", "Interior", None, None, None),
    ("Pradópolis", "Interior", None, None, None),
    ("Praia Grande", "Grande SP", None, None, None),
    ("Pratânia", "Interior", None, None, None),
    ("Presidente Alves", "Interior", None, None, None),
    ("Presidente Bernardes", "Interior", None, None, None),
    ("Presidente Epitácio", "Interior", None, None, None),
    ("Presidente Prudente", "Interior", None, None, None),
    ("Presidente Venceslau", "Interior", None, None, None),
    ("Promissão", "Interior", None, None, None),
    ("Quadra", "Interior", None, None, None),
    ("Quatá", "Interior", None, None, None),
    ("Queiroz", "Interior", None, None, None),
    ("Queluz", "Vale do Paraíba", None, None, None),
    ("Quintana", "Interior", None, None, None),
    ("Rafard", "Interior", None, None, None),
    ("Rancharia", "Interior", None, None, None),
    ("Redenção da Serra", "Vale do Paraíba", None, None, None),
    ("Regente Feijó", "Interior", None, None, None),
    ("Reginópolis", "Interior", None, None, None),
    ("Registro", "Litoral", None, None, None),
    ("Restinga", "Interior", None, None, None),
    ("Ribeira", "Interior", None, None, None),
    ("Ribeirão Bonito", "Interior", None, None, None),
    ("Ribeirão Branco", "Interior", None, None, None),
    ("Ribeirão Corrente", "Interior", None, None, None),
    ("Ribeirão Grande", "Interior", None, None, None),
    ("Ribeirão Pires", "Grande SP", None, None, None),
    ("Ribeirão Preto", "Interior", None, None, None),
    ("Ribeirão do Sul", "Interior", None, None, None),
    ("Ribeirão dos Índios", "Interior", None, None, None),
    ("Rifaina", "Interior", None, None, None),
    ("Rincão", "Interior", None, None, None),
    ("Rinópolis", "Interior", None, None, None),
    ("Rio Claro", "Interior", None, None, None),
    ("Rio Grande da Serra", "Grande SP", None, None, None),
    ("Rio das Pedras", "Interior", None, None, None),
    ("Riolândia", "Interior", None, None, None),
    ("Riversul", "Interior", None, None, None),
    ("Rosana", "Interior", None, None, None),
    ("Roseira", "Vale do Paraíba", None, None, None),
    ("Rubinéia", "Interior", None, None, None),
    ("Rubiácea", "Interior", None, None, None),
    ("Sabino", "Interior", None, None, None),
    ("Sagres", "Interior", None, None, None),
    ("Sales", "Interior", None, None, None),
    ("Sales Oliveira", "Interior", None, None, None),
    ("Salesópolis", "Grande SP", None, None, None),
    ("Salmourão", "Interior", None, None, None),
    ("Saltinho", "Interior", None, None, None),
    ("Salto", "Interior", None, None, None),
    ("Salto Grande", "Interior", None, None, None),
    ("Salto de Pirapora", "Interior", None, None, None),
    ("Sandovalina", "Interior", None, None, None),
    ("Santa Adélia", "Interior", None, None, None),
    ("Santa Albertina", "Interior", None, None, None),
    ("Santa Branca", "Vale do Paraíba", None, None, None),
    ("Santa Bárbara d'Oeste", "Interior", None, None, None),
    ("Santa Clara d'Oeste", "Interior", None, None, None),
    ("Santa Cruz da Conceição", "Interior", None, None, None),
    ("Santa Cruz da Esperança", "Interior", None, None, None),
    ("Santa Cruz das Palmeiras", "Interior", None, None, None),
    ("Santa Cruz do Rio Pardo", "Interior", None, None, None),
    ("Santa Ernestina", "Interior", None, None, None),
    ("Santa Fé do Sul", "Interior", None, None, None),
    ("Santa Gertrudes", "Interior", None, None, None),
    ("Santa Isabel", "Grande SP", None, None, None),
    ("Santa Lúcia", "Interior", None, None, None),
    ("Santa Maria da Serra", "Interior", None, None, None),
    ("Santa Mercedes", "Interior", None, None, None),
    ("Santa Rita d'Oeste", "Interior", None, None, None),
    ("Santa Rita do Passa Quatro", "Interior", None, None, None),
    ("Santa Rosa de Viterbo", "Interior", None, None, None),
    ("Santa Salete", "Interior", None, None, None),
    ("Santana da Ponte Pensa", "Interior", None, None, None),
    ("Santana de Parnaíba", "Grande SP", None, None, None),
    ("Santo Anastácio", "Interior", None, None, None),
    ("Santo André", "Grande SP", None, None, None),
    ("Santo Antônio da Alegria", "Interior", None, None, None),
    ("Santo Antônio de Posse", "Interior", None, None, None),
    ("Santo Antônio do Aracanguá", "Interior", None, None, None),
    ("Santo Antônio do Jardim", "Interior", None, None, None),
    ("Santo Antônio do Pinhal", "Vale do Paraíba", None, None, None),
    ("Santo Expedito", "Interior", None, None, None),
    ("Santos", "Grande SP", None, None, None),
    ("Santópolis do Aguapeí", "Interior", None, None, None),
    ("Sarapuí", "Interior", None, None, None),
    ("Sarutaiá", "Interior", None, None, None),
    ("Sebastianópolis do Sul", "Interior", None, None, None),
    ("Serra Azul", "Interior", None, None, None),
    ("Serra Negra", "Interior", None, None, None),
    ("Serrana", "Interior", None, None, None),
    ("Sertãozinho", "Interior", None, None, None),
    ("Sete Barras", "Litoral", None, None, None),
    ("Severínia", "Interior", None, None, None),
    ("Silveiras", "Vale do Paraíba", None, None, None),
    ("Socorro", "Interior", None, None, None),
    ("Sorocaba", "Interior", None, None, None),
    ("Sud Mennucci", "Interior", None, None, None),
    ("Sumaré", "Interior", None, None, None),
    ("Suzano", "Grande SP", None, None, None),
    ("Suzanápolis", "Interior", None, None, None),
    ("São Bento do Sapucaí", "Vale do Paraíba", None, None, None),
    ("São Bernardo do Campo", "Grande SP", None, None, None),
    ("São Caetano do Sul", "Grande SP", None, None, None),
    ("São Carlos", "Interior", None, None, None),
    ("São Francisco", "Interior", None, None, None),
    ("São Joaquim da Barra", "Interior", None, None, None),
    ("São José da Bela Vista", "Interior", None, None, None),
    ("São José do Barreiro", "Vale do Paraíba", None, None, None),
    ("São José do Rio Pardo", "Interior", None, None, None),
    ("São José do Rio Preto", "Interior", None, None, None),
    ("São José dos Campos", "Vale do Paraíba", None, None, None),
    ("São João da Boa Vista", "Interior", None, None, None),
    ("São João das Duas Pontes", "Interior", None, None, None),
    ("São João de Iracema", "Interior", None, None, None),
    ("São João do Pau d'Alho", "Interior", None, None, None),
    ("São Lourenço da Serra", "Grande SP", None, None, None),
    ("São Luiz do Paraitinga", "Vale do Paraíba", None, None, None),
    ("São Manuel", "Interior", None, None, None),
    ("São Miguel Arcanjo", "Interior", None, None, None),
    ("São Paulo", "Grande SP", None, None, None),
    ("São Pedro", "Interior", None, None, None),
    ("São Pedro do Turvo", "Interior", None, None, None),
    ("São Roque", "Interior", None, None, None),
    ("São Sebastião", "Vale do Paraíba", None, None, None),
    ("São Sebastião da Grama", "Interior", None, None, None),
    ("São Simão", "Interior", None, None, None),
    ("São Vicente", "Grande SP", None, None, None),
    ("Tabapuã", "Interior", None, None, None),
    ("Tabatinga", "Interior", None, None, None),
    ("Taboão da Serra", "Grande SP", None, None, None),
    ("Taciba", "Interior", None, None, None),
    ("Taguaí", "Interior", None, None, None),
    ("Taiaçu", "Interior", None, None, None),
    ("Taiúva", "Interior", None, None, None),
    ("Tambaú", "Interior", None, None, None),
    ("Tanabi", "Interior", None, None, None),
    ("Tapiratiba", "Interior", None, None, None),
    ("Tapiraí", "Interior", None, None, None),
    ("Taquaral", "Interior", None, None, None),
    ("Taquaritinga", "Interior", None, None, None),
    ("Taquarituba", "Interior", None, None, None),
    ("Taquarivaí", "Interior", None, None, None),
    ("Tarabai", "Interior", None, None, None),
    ("Tarumã", "Interior", None, None, None),
    ("Tatuí", "Interior", None, None, None),
    ("Taubaté", "Vale do Paraíba", None, None, None),
    ("Tejupá", "Interior", None, None, None),
    ("Teodoro Sampaio", "Interior", None, None, None),
    ("Terra Roxa", "Interior", None, None, None),
    ("Tietê", "Interior", None, None, None),
    ("Timburi", "Interior", None, None, None),
    ("Torre de Pedra", "Interior", None, None, None),
    ("Torrinha", "Interior", None, None, None),
    ("Trabiju", "Interior", None, None, None),
    ("Tremembé", "Vale do Paraíba", None, None, None),
    ("Três Fronteiras", "Interior", None, None, None),
    ("Tuiuti", "Interior", None, None, None),
    ("Tupi Paulista", "Interior", None, None, None),
    ("Tupã", "Interior", None, None, None),
    ("Turiúba", "Interior", None, None, None),
    ("Turmalina", "Interior", None, None, None),
    ("Ubarana", "Interior", None, None, None),
    ("Ubatuba", "Vale do Paraíba", None, None, None),
    ("Ubirajara", "Interior", None, None, None),
    ("Uchoa", "Interior", None, None, None),
    ("União Paulista", "Interior", None, None, None),
    ("Uru", "Interior", None, None, None),
    ("Urupês", "Interior", None, None, None),
    ("Urânia", "Interior", None, None, None),
    ("Valentim Gentil", "Interior", None, None, None),
    ("Valinhos", "Interior", None, None, None),
    ("Valparaíso", "Interior", None, None, None),
    ("Vargem", "Interior", None, None, None),
    ("Vargem Grande Paulista", "Grande SP", None, None, None),
    ("Vargem Grande do Sul", "Interior", None, None, None),
    ("Vera Cruz", "Interior", None, None, None),
    ("Vinhedo", "Interior", None, None, None),
    ("Viradouro", "Interior", None, None, None),
    ("Vista Alegre do Alto", "Interior", None, None, None),
    ("Vitória Brasil", "Interior", None, None, None),
    ("Votorantim", "Interior", None, None, None),
    ("Votuporanga", "Interior", None, None, None),
    ("Várzea Paulista", "Interior", None, None, None),
    ("Zacarias", "Interior", None, None, None),
    ("Águas da Prata", "Interior", None, None, None),
    ("Águas de Lindóia", "Interior", None, None, None),
    ("Águas de Santa Bárbara", "Interior", None, None, None),
    ("Águas de São Pedro", "Interior", None, None, None),
    ("Álvares Florence", "Interior", None, None, None),
    ("Álvares Machado", "Interior", None, None, None),
    ("Álvaro de Carvalho", "Interior", None, None, None),
    ("Óleo", "Interior", None, None, None),
]
